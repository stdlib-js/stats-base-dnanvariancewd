...
```javascript
dnanvariancewd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dnanvariancewd@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dnanvariancewd@umd/bundle.js"></script>
```
